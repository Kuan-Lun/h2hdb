...
CATALOG_PHYSICAL_DOMAIN_RELATIONS = frozenset(
    {
        ...
        "gallery_observation_file_artifact_role",
...
# These non-materialized logical views remain inside the physical-domain authority
# closure, but no writer family may claim them as mutation targets.
